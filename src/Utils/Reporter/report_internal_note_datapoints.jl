# ============================================================================
# src/Utils/Reporter/report_internal_note_datapoints.jl
#
...
"""
    _build_internal_note_figures_tex_datapoints(
        datapoints_plot_name;
        title, rule, boundary, h_power, xscale, yscale
    ) -> String
...
- `title`: Experiment or dataset title used in labels and caption text.
...
- The caption uses `\\texorpdfstring` to preserve [``\\LaTeX``](https://www.latex-project.org/) formatting in the
  document body while remaining compatible with PDF bookmarks.
