@inline function smzk_scalar_block(
    ...
    # ------------------------------------------------------------
    # Symanzik scalar preparation block
    # Pure algebra, no tensor construction.
    # ------------------------------------------------------------
    ...
    x3_smzk_prop =
        (1.0/6.0)*sum_khat_sq_6t + 0.5*sum_khat_sq_sq*sum_khat_4t_sq
        - sum_khat_sq_4t*sum_khat_4t
        + (4.0/3.0)*sum_khat_sq_3t*sum_khat_6t
