# ============================================================================
# src/ErrorEstimate/ErrorDispatch/internal/_resolve_error_dispatch_type_and_lambda.jl
#
...
"""
    _resolve_error_dispatch_type_and_lambda(
        a,
        b,
        λ,
        real_type,
...
- `λ`:
  Optional refinement parameter supplied to the public dispatcher.
- `real_type`:
...
"""
function _resolve_error_dispatch_type_and_lambda(
    a,
    b,
    λ,
    real_type,
