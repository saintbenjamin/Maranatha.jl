# ============================================================================
# src/ErrorEstimate/ErrorDispatch/ErrorDispatchDerivative/internal/_dispatch_error_estimate_derivative_jet_by_dim.jl
#
...
"""
    _dispatch_error_estimate_derivative_jet_by_dim(
        f,
        a,
        b,
        N,
...
Dispatch the jet-based derivative error estimator to the dimension-specific
...
# Returns
- The named tuple returned by the selected dimension-specific jet estimator.

# Errors
- Propagates any validation or computation error thrown by the selected
  dimension-specific jet estimator.
"""
function _dispatch_error_estimate_derivative_jet_by_dim(
    f,
    a,
    b,
    N,
