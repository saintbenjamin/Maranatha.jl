...
makedocs(
    ...
    pages = [
        ...
        "ErrorEstimate"              => Any[
            ...
            "ErrorDispatchRefine"    => "lib/ErrorDispatchRefine.md",
            "ErrorBSpline"           => "lib/ErrorBSpline.md",
            "ErrorBSplineRefine"     => "lib/ErrorBSplineRefine.md",
            "ErrorGauss"             => "lib/ErrorGauss.md",
            "ErrorGaussRefine"       => "lib/ErrorGaussRefine.md",
            "ErrorNewtonCotes"       => "lib/ErrorNewtonCotes.md",
            "ErrorNewtonCotesRefine" => "lib/ErrorNewtonCotesRefine.md",
        ],
