@inline function smzk_tensor_block(
    ...
    m_mn_smzk_prop_11 = khat_1_sq*sum_khat_sq - 2.0*khat_1_4t + khat_1_sq*sum_khat_4t*inv_sum_khat_sq
    m_mn_smzk_prop_22 = khat_2_sq*sum_khat_sq - 2.0*khat_2_4t + khat_2_sq*sum_khat_4t*inv_sum_khat_sq
    m_mn_smzk_prop_33 = khat_3_sq*sum_khat_sq - 2.0*khat_3_4t + khat_3_sq*sum_khat_4t*inv_sum_khat_sq
    m_mn_smzk_prop_44 = khat_4_sq*sum_khat_sq - 2.0*khat_4_4t + khat_4_sq*sum_khat_4t*inv_sum_khat_sq
    ...
    m_sq_mn_smzk_prop_11 = khat_1_4t*sum_khat_sq_sq - 3.0*khat_1_6t*sum_khat_sq + 2.0*khat_1_4t*sum_khat_4t + khat_1_sq*sum_khat_6t - khat_1_sq*sum_khat_4t_sq*inv_sum_khat_sq
    m_sq_mn_smzk_prop_22 = khat_2_4t*sum_khat_sq_sq - 3.0*khat_2_6t*sum_khat_sq + 2.0*khat_2_4t*sum_khat_4t + khat_2_sq*sum_khat_6t - khat_2_sq*sum_khat_4t_sq*inv_sum_khat_sq
    m_sq_mn_smzk_prop_33 = khat_3_4t*sum_khat_sq_sq - 3.0*khat_3_6t*sum_khat_sq + 2.0*khat_3_4t*sum_khat_4t + khat_3_sq*sum_khat_6t - khat_3_sq*sum_khat_4t_sq*inv_sum_khat_sq
    m_sq_mn_smzk_prop_44 = khat_4_4t*sum_khat_sq_sq - 3.0*khat_4_6t*sum_khat_sq + 2.0*khat_4_4t*sum_khat_4t + khat_4_sq*sum_khat_6t - khat_4_sq*sum_khat_4t_sq*inv_sum_khat_sq

    m_sq_mn_smzk_prop_12 = - ( khat_1_4t + khat_2_4t + khat_1_sq * khat_2_sq ) * sum_khat_sq + ( khat_1_sq + khat_2_sq ) * sum_khat_4t + sum_khat_6t - sum_khat_4t_sq * inv_sum_khat_sq
    m_sq_mn_smzk_prop_13 = - ( khat_1_4t + khat_3_4t + khat_1_sq * khat_3_sq ) * sum_khat_sq + ( khat_1_sq + khat_3_sq ) * sum_khat_4t + sum_khat_6t - sum_khat_4t_sq * inv_sum_khat_sq
    m_sq_mn_smzk_prop_14 = - ( khat_1_4t + khat_4_4t + khat_1_sq * khat_4_sq ) * sum_khat_sq + ( khat_1_sq + khat_4_sq ) * sum_khat_4t + sum_khat_6t - sum_khat_4t_sq * inv_sum_khat_sq
    m_sq_mn_smzk_prop_23 = - ( khat_2_4t + khat_3_4t + khat_2_sq * khat_3_sq ) * sum_khat_sq + ( khat_2_sq + khat_3_sq ) * sum_khat_4t + sum_khat_6t - sum_khat_4t_sq * inv_sum_khat_sq
    m_sq_mn_smzk_prop_24 = - ( khat_2_4t + khat_4_4t + khat_2_sq * khat_4_sq ) * sum_khat_sq + ( khat_2_sq + khat_4_sq ) * sum_khat_4t + sum_khat_6t - sum_khat_4t_sq * inv_sum_khat_sq
    m_sq_mn_smzk_prop_34 = - ( khat_3_4t + khat_4_4t + khat_3_sq * khat_4_sq ) * sum_khat_sq + ( khat_3_sq + khat_4_sq ) * sum_khat_4t + sum_khat_6t - sum_khat_4t_sq * inv_sum_khat_sq
