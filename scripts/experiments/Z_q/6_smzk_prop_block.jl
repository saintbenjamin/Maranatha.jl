@inline function smzk_prop_block(
    ...
    imp_smzk_prop_feyn_11 = coeff_delta_t*delta_t_smzk_prop_11 + coeff_m_mn*m_mn_smzk_prop_11 + coeff_m_sq_mn*m_sq_mn_smzk_prop_11 + inv_sum_khat_sq*p_mn_smzk_prop_11
    
    imp_smzk_prop_feyn_22 = coeff_delta_t*delta_t_smzk_prop_22 + coeff_m_mn*m_mn_smzk_prop_22 + coeff_m_sq_mn*m_sq_mn_smzk_prop_22 + inv_sum_khat_sq*p_mn_smzk_prop_22

    imp_smzk_prop_feyn_33 = coeff_delta_t*delta_t_smzk_prop_33 + coeff_m_mn*m_mn_smzk_prop_33 + coeff_m_sq_mn*m_sq_mn_smzk_prop_33 + inv_sum_khat_sq*p_mn_smzk_prop_33

    imp_smzk_prop_feyn_44 = coeff_delta_t*delta_t_smzk_prop_44 + coeff_m_mn*m_mn_smzk_prop_44 + coeff_m_sq_mn*m_sq_mn_smzk_prop_44 + inv_sum_khat_sq*p_mn_smzk_prop_44

    imp_smzk_prop_feyn_12 = coeff_delta_t*delta_t_smzk_prop_12 + coeff_m_mn*m_mn_smzk_prop_12 + coeff_m_sq_mn*m_sq_mn_smzk_prop_12 + inv_sum_khat_sq*p_mn_smzk_prop_12
    
    imp_smzk_prop_feyn_13 = coeff_delta_t*delta_t_smzk_prop_13 + coeff_m_mn*m_mn_smzk_prop_13 + coeff_m_sq_mn*m_sq_mn_smzk_prop_13 + inv_sum_khat_sq*p_mn_smzk_prop_13

    imp_smzk_prop_feyn_14 = coeff_delta_t*delta_t_smzk_prop_14 + coeff_m_mn*m_mn_smzk_prop_14 + coeff_m_sq_mn*m_sq_mn_smzk_prop_14 + inv_sum_khat_sq*p_mn_smzk_prop_14

    imp_smzk_prop_feyn_23 = coeff_delta_t*delta_t_smzk_prop_23 + coeff_m_mn*m_mn_smzk_prop_23 + coeff_m_sq_mn*m_sq_mn_smzk_prop_23 + inv_sum_khat_sq*p_mn_smzk_prop_23
    imp_smzk_prop_feyn_24 = coeff_delta_t*delta_t_smzk_prop_24 + coeff_m_mn*m_mn_smzk_prop_24 + coeff_m_sq_mn*m_sq_mn_smzk_prop_24 + inv_sum_khat_sq*p_mn_smzk_prop_24

    imp_smzk_prop_feyn_34 = coeff_delta_t*delta_t_smzk_prop_34 + coeff_m_mn*m_mn_smzk_prop_34 + coeff_m_sq_mn*m_sq_mn_smzk_prop_34 + inv_sum_khat_sq*p_mn_smzk_prop_34
