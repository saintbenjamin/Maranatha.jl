...
est1, fit1, res1 = run_Maranatha(f1d, bounds...; dim=1, nsamples=ns_3, rule=:simpson38)
println("Estimate: ", est1)
println("Fit: ", fit1)
plot_convergence_result("1D", res1.h, res1.avg, res1.err, fit1; rule=:simpson38)
println()

println("▶ 1D Test Bode")
est1, fit1, res1 = run_Maranatha(f1d, bounds...; dim=1, nsamples=ns, rule=:bode)
println("Estimate: ", est1)
println("Fit: ", fit1)
plot_convergence_result("1D", res1.h, res1.avg, res1.err, fit1; rule=:bode)
println()
