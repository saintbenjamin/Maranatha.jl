...
println("▶ 1D Test Simpson 1/3 Opened")
...
println("▶ 1D Test Simpson 3/8 Opened")
...
# est2, fit2, res2 = run_Maranatha(f2d, bounds...; dim=2, nsamples=ns, rule=:simpson13_close)
# plot_convergence_result("2D", res2.h, res2.avg, res2.err, fit2; rule=:simpson13_close)
# println()
...
# est2, fit2, res2 = run_Maranatha(f2d, bounds...; dim=2, nsamples=ns, rule=:bode_close)
# plot_convergence_result("2D", res2.h, res2.avg, res2.err, fit2; rule=:bode_close)
# println()
