@testset "3D rules" begin
    ...
    @testset "Gauss 2-point LU_ININ" begin
        announce("3D rules :: Gauss 2-point LU_ININ")
        dim = 3
        rule = :gauss_p2
        boundary = :LU_ININ
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
    ...
    @testset "Gauss 2-point LU_INEX" begin
        announce("3D rules :: Gauss 2-point LU_INEX")
        dim = 3
        rule = :gauss_p2
        boundary = :LU_INEX
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
    ...
    @testset "Gauss 2-point LU_EXIN" begin
        announce("3D rules :: Gauss 2-point LU_EXIN")
        dim = 3
        rule = :gauss_p2
        boundary = :LU_EXIN
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
    ...
    @testset "Gauss 3-point LU_ININ" begin
        announce("3D rules :: Gauss 3-point LU_ININ")
        dim = 3
        rule = :gauss_p3
        boundary = :LU_ININ
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
    ...
    @testset "Gauss 3-point LU_INEX" begin
        announce("3D rules :: Gauss 3-point LU_INEX")
        dim = 3
        rule = :gauss_p3
        boundary = :LU_INEX
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
    ...
    @testset "Gauss 3-point LU_EXIN" begin
        announce("3D rules :: Gauss 3-point LU_EXIN")
        dim = 3
        rule = :gauss_p3
        boundary = :LU_EXIN
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
    ...
    @testset "Gauss 4-point LU_ININ" begin
        announce("3D rules :: Gauss 4-point LU_ININ")
        dim = 3
        rule = :gauss_p4
        boundary = :LU_ININ
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
    ...
    @testset "Gauss 4-point LU_INEX" begin
        announce("3D rules :: Gauss 4-point LU_INEX")
        dim = 3
        rule = :gauss_p4
        boundary = :LU_INEX
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
    ...
    @testset "Gauss 4-point LU_EXIN" begin
        announce("3D rules :: Gauss 4-point LU_EXIN")
        dim = 3
        rule = :gauss_p4
        boundary = :LU_EXIN
        ns = [2, 3, 4, 5, 6, 7, 8, 9]
