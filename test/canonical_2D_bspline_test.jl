@testset "2D rules" begin
    ...
    @testset "2D B-spline 3-point LU_ININ" begin
        announce("2D rules :: B-spline 3-point LU_ININ")
        dim = 2
    ...
    @testset "2D B-spline 4-point LU_ININ" begin
        announce("2D rules :: B-spline 4-point LU_ININ")
        dim = 2
    ...
    @testset "2D B-spline 5-point LU_ININ" begin
        announce("2D rules :: B-spline 5-point LU_ININ")
        dim = 2
    ...
    @testset "2D B-spline 6-point LU_ININ" begin
        announce("2D rules :: B-spline 6-point LU_ININ")
        dim = 2
    ...
    @testset "2D B-spline 7-point LU_ININ" begin
        announce("2D rules :: B-spline 7-point LU_ININ")
        dim = 2
