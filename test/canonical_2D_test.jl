@testset "2D rules" begin
    ...
    @testset "6-point LU_ININ" begin
        announce("2D rules :: 6-point LU_ININ")
        dim = 2
        rule = :newton_p6
        boundary = :LU_ININ
    ...
    @testset "6-point LU_INEX" begin
        announce("2D rules :: 6-point LU_INEX")
        dim = 2
        rule = :newton_p6
        boundary = :LU_INEX
        ns = [10, 15, 20, 25, 30, 35, 40, 45, 50]
    ...
    @testset "6-point LU_EXIN" begin
        announce("2D rules :: 6-point LU_EXIN")
        dim = 2
        rule = :newton_p6
        boundary = :LU_EXIN
        ns = [10, 15, 20, 25, 30, 35, 40, 45, 50]
    ...
    @testset "6-point LU_EXEX" begin
        announce("2D rules :: 6-point LU_EXEX")
        dim = 2
        rule = :newton_p6
        boundary = :LU_EXEX
        ns = [10, 15, 20, 25, 30, 35, 40, 45, 50]
    ...
    @testset "7-point LU_ININ" begin
        announce("2D rules :: 7-point LU_ININ")
        dim = 2
        rule = :newton_p7
        boundary = :LU_ININ
    ...
    @testset "7-point LU_INEX" begin
        announce("2D rules :: 7-point LU_INEX")
        dim = 2
        rule = :newton_p7
        boundary = :LU_INEX
        ns = [12, 18, 24, 30, 36, 42, 48, 54, 60]
    ...
    @testset "7-point LU_EXIN" begin
        announce("2D rules :: 7-point LU_EXIN")
        dim = 2
        rule = :newton_p7
        boundary = :LU_EXIN
        ns = [12, 18, 24, 30, 36, 42, 48, 54, 60]
    ...
    @testset "7-point LU_EXEX" begin
        announce("2D rules :: 7-point LU_EXEX")
        dim = 2
        rule = :newton_p7
        boundary = :LU_EXEX
        ns = [12, 18, 24, 30, 36, 42, 48, 54, 60]
