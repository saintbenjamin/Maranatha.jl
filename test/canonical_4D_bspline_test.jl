@testset "4D rules" begin
    ...
    @testset "4D B-spline 2-point interp LU_ININ" begin
        announce("4D rules :: B-spline 2-point interp LU_ININ")
        dim = 4
    ...
    @testset "4D B-spline 2-point smooth LU_ININ" begin
        announce("4D rules :: B-spline 2-point smooth LU_ININ")
        dim = 4
    ...
    @testset "4D B-spline 3-point LU_ININ" begin
        announce("4D rules :: B-spline 3-point LU_ININ")
        dim = 4
    ...
    @testset "4D B-spline 4-point LU_ININ" begin
        announce("4D rules :: B-spline 4-point LU_ININ")
        dim = 4
    ...
    @testset "4D B-spline 5-point LU_ININ" begin
        announce("4D rules :: B-spline 5-point LU_ININ")
        dim = 4
    ...
    @testset "4D B-spline 6-point LU_ININ" begin
        announce("4D rules :: B-spline 6-point LU_ININ")
        dim = 4
    ...
    @testset "4D B-spline 7-point LU_ININ" begin
        announce("4D rules :: B-spline 7-point LU_ININ")
        dim = 4
